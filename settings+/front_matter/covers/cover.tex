...
\renewcommand*{\maketitle} {
    ...
    \begin{titlepage}
        ...
        \begin{tikzpicture}[remember picture,overlay]
            ...
            \node[anchor=south west, xshift = -1mm, yshift = -1mm] at (BL) {
                \includegraphics[height=1cm]{cover/sensopart-logo.png}
            };
...
\newcommand{\examinerSupervisors} {
    \begin{titlepage}
        ...
        \begin{center}
            ...
            \begin{tabular}{p{3.5cm}p{10cm}}
                ...
                \textbf{\examinerstitle}   & \@firstExaminer,\\
                                           ...
                                           & \\
                \textbf{\supervisorstitle} & \@firstSupervisor,\\
                                           & \@firstSupervisorDepartment\\
                                           & \@firstSupervisorChair\\
                                           & \\

                                           \ifdefined \@secondSupervisor
                                              & \@secondSupervisor,\\
                                              & \@secondSupervisorDepartment\\
                                           ...
                                           \ifdefined \@thirdSupervisor
                                              & \@thirdSupervisor,\\
                                              & \@thirdSupervisorDepartment\\
                                              & \@thirdSupervisorChair\\
                                           \else
                                               & \\
                                               & \\
                                           \fi
        ...
        \begin{tikzpicture}[remember picture,overlay]
            ...
            \node[anchor=south east, xshift = -1mm, yshift = -1mm] at (BR) {
                \includegraphics[height=1.5cm]{cover/sensopart-logo.png}
            };
