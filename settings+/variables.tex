...
\newcommand*{\firstSupervisorDepartment}[1]{\gdef\@firstSupervisorDepartment{#1}}
\newcommand*{\firstSupervisorChair}[1]{\gdef\@firstSupervisorChair{#1}}
\newcommand*{\secondSupervisor}[1]{\gdef\@secondSupervisor{#1}}
\newcommand*{\secondSupervisorDepartment}[1]{\gdef\@secondSupervisorDepartment{#1}}
\newcommand*{\secondSupervisorChair}[1]{\gdef\@secondSupervisorChair{#1}}
\newcommand*{\thirdSupervisor}[1]{\gdef\@thirdSupervisor{#1}}
\newcommand*{\thirdSupervisorDepartment}[1]{\gdef\@thirdSupervisorDepartment{#1}}
\newcommand*{\thirdSupervisorChair}[1]{\gdef\@thirdSupervisorChair{#1}}
